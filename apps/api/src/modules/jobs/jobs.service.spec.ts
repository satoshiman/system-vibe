...
describe('JobsService', () => {
  ...
  describe('findOne', () => {
    ...
    it('should throw NotFoundException if job not found', async () => {
      ...
      await expect(service.findOne('nonexistent-id', 'user-id')).rejects.toThrow(NotFoundException);
    });
  ...
  describe('cancel', () => {
    ...
    it('should throw NotFoundException if job not found', async () => {
      ...
      await expect(service.cancel('nonexistent-id', 'user-id')).rejects.toThrow(NotFoundException);
    });
